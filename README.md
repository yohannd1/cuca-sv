...
At the moment I am working on a single-bus implementation with
microprograms and no pipelining, and it might stay that way since it's
pretty close to what the teacher gave.

Also, there are no formal written specs for these architectures, so I
aim to do that in the future.

## building / testing

I want this project to eventually target FPGAs. Beware that I'm a novice
FPGA programmer, though, and I haven't tested much yet.
